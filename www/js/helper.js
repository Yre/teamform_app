helperApp = angular.module('tfApp.services',['firebase'])

helperApp.factory("Auth", function($firebaseAuth) {
    return $firebaseAuth();
});

helperApp.factory("Helper", function($firebaseArray, $firebaseObject) {
    helper = {};
    helper.debug = {};
    //checked
